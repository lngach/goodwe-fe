...
//       title: 'TeslaPower VN - Sửa chữa lắp đặt thiết bị vi tính',
//       newProducts,
//       topSellProducts,
//       topViewProducts,
//       newProducts,
...
router.get('/', async (_, res) => {
  try {
    ...
    res.render('user/index', { title: 'Trang Chủ - TeslaPower  VN', inverters, solarPins, solarFans, solarLeds, solarCameras })
  } catch (error) {
    res.render('user/index', {
      title: 'Trang Chủ - TeslaPower  VN',
      inverters: [],
      solarPins: [],
      solarFans: [],
      solarLeds: [],
